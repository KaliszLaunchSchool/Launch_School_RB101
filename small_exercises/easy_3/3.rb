...
Discussion
We don't want to count spaces here, so we use String#delete to return a new String with all spaces removed 
from it. The original string stored in input is left intact.
=end
