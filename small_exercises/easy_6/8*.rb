...
# Problem
- Given an unordered array, return the one value which occurs twice 
...
# Algo
- iterate through the array in order, comparing the number with every other number
- Select and return the number if the the 2 numbers are ==
# Code
=end
