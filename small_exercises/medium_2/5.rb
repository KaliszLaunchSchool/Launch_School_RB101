...
Discussion
A triangle's two smaller sides should be greater than the length of the largest. The thing is, we don't know 
which of our sides was chosen as the "largest" when we call max on sides. So, to check for this, we make sure 
that the total sum of the side lengths is greater than 2 times the largest side. Another way to express this 
would be: largest_side > sides.reduce(:+) - largest_side
=end
